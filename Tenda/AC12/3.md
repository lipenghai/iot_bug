## Tenda AC12
The issue described here is the same as: CVE-2022-37812
...
void __cdecl formSetFirewallCfg(webs_t wp, char_t *path, char_t *query)
{
  ...
  firewall_value = websGetVar(wp, "firewallEn", "1111");          // <--- source: read the firewallEn field value
  if ( strlen(firewall_value) >= 4 )
  {
    strcpy(firewall_buf, firewall_value);         // <--- sink: copy the user-controlled firewallEn value into the fixed stack buffer firewall_buf
